...
export default function Input({
  ...
  return (
    <input
      ...
      className={`w-full focus:border-primary bg-white border border-border border-opacity-5 rounded-[3.125rem]  py-3.5 px-5 h-12 outline-none text-textColor font-medium text-sm ${className}`}
    />
  );
}
